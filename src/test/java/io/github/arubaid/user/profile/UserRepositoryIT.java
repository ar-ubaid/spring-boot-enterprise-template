package io.github.arubaid.user.profile;
...
public class UserRepositoryIT extends AbstractIntegrationTest {
    ...
    void shouldFindUserById() {
        ...
        assertThat(foundUser.get().getEmail()).isEqualTo("id@example.com");
    }
    ...
    void shouldHandleEmailCaseSensitivity() {
        ...
        // When & Then
        // findByEmail should be case-sensitive by default (depends on database collation)
        assertThat(repository.findByEmail("casesensitive@example.com")).isEmpty();
        assertThat(repository.findByEmail("CaseSensitive@example.com")).isPresent();
    }
